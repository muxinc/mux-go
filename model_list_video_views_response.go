...
// ListVideoViewsResponse struct for ListVideoViewsResponse
...
// SetData gets a reference to the given []AbridgedVideoView and assigns it to the Data field.
...
func (o ListVideoViewsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListVideoViewsResponse struct {
	value *ListVideoViewsResponse
	isSet bool
}

func (v NullableListVideoViewsResponse) Get() *ListVideoViewsResponse {
	return v.value
}

func (v *NullableListVideoViewsResponse) Set(val *ListVideoViewsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListVideoViewsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListVideoViewsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListVideoViewsResponse(val *ListVideoViewsResponse) *NullableListVideoViewsResponse {
	return &NullableListVideoViewsResponse{value: val, isSet: true}
}

func (v NullableListVideoViewsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListVideoViewsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
