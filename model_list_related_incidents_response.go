...
// ListRelatedIncidentsResponse struct for ListRelatedIncidentsResponse
...
func NewListRelatedIncidentsResponse() *ListRelatedIncidentsResponse {
	this := ListRelatedIncidentsResponse{}
	return &this
}
...
func (o ListRelatedIncidentsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListRelatedIncidentsResponse struct {
	value *ListRelatedIncidentsResponse
	isSet bool
}

func (v NullableListRelatedIncidentsResponse) Get() *ListRelatedIncidentsResponse {
	return v.value
}

func (v *NullableListRelatedIncidentsResponse) Set(val *ListRelatedIncidentsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListRelatedIncidentsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListRelatedIncidentsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListRelatedIncidentsResponse(val *ListRelatedIncidentsResponse) *NullableListRelatedIncidentsResponse {
	return &NullableListRelatedIncidentsResponse{value: val, isSet: true}
}

func (v NullableListRelatedIncidentsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListRelatedIncidentsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
