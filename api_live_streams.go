...
func (a *LiveStreamsApiService) DeleteLiveStreamStaticRenditions(lIVESTREAMID string, opts ...APIOption) error {
	var (
		localVarAPIOptions   = new(APIOptions)
		localVarHttpMethod   = strings.ToUpper("Delete")
		localVarPostBody     interface{}
...
func (a *LiveStreamsApiService) UpdateLiveStreamStaticRenditions(lIVESTREAMID string, updateLiveStreamNewAssetSettingsStaticRenditionsRequest UpdateLiveStreamNewAssetSettingsStaticRenditionsRequest, opts ...APIOption) (LiveStreamResponse, error) {
	var (
		localVarAPIOptions   = new(APIOptions)
		localVarHttpMethod   = strings.ToUpper("Put")
		localVarPostBody     interface{}
