...
type Incident struct {
	...
	AffectedViewsPerHourOnOpen float64                    `json:"affected_views_per_hour_on_open,omitempty"`
	AffectedViewsPerHour       float64                    `json:"affected_views_per_hour,omitempty"`
	AffectedViews              float64                    `json:"affected_views,omitempty"`
}
