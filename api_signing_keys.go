...
type SigningKeysApiService service

func (a *SigningKeysApiService) CreateSigningKey(opts ...APIOption) (SigningKeyResponse, error) {
	var (
	...
	localVarPath := a.client.cfg.basePath + "/system/v1/signing-keys"
...
func (a *SigningKeysApiService) DeleteSigningKey(sIGNINGKEYID string, opts ...APIOption) error {
	var (
		localVarAPIOptions   = new(APIOptions)
	...
	// create path and map variables
	localVarPath := a.client.cfg.basePath + "/system/v1/signing-keys/{SIGNING_KEY_ID}"
...
func (a *SigningKeysApiService) GetSigningKey(sIGNINGKEYID string, opts ...APIOption) (SigningKeyResponse, error) {
	var (
		localVarAPIOptions   = new(APIOptions)
...
// ListSigningKeys optionally accepts the APIOption of WithParams(*ListSigningKeysParams).
func (a *SigningKeysApiService) ListSigningKeys(opts ...APIOption) (ListSigningKeysResponse, error) {
	var (
		localVarAPIOptions   = new(APIOptions)
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
	...
	localVarOptionals, ok := localVarAPIOptions.params.(*ListSigningKeysParams)
	if localVarAPIOptions.params != nil && !ok {
		return localVarReturnValue, reportError("provided params were not of type *ListSigningKeysParams")
	}
