...
> DeleteLiveStreamStaticRenditions(ctx, lIVESTREAMID)
...
> LiveStreamResponse UpdateLiveStreamStaticRenditions(ctx, lIVESTREAMID, updateLiveStreamNewAssetSettingsStaticRenditionsRequest)
