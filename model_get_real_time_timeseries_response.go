...
// GetRealTimeTimeseriesResponse struct for GetRealTimeTimeseriesResponse
...
func NewGetRealTimeTimeseriesResponse() *GetRealTimeTimeseriesResponse {
	this := GetRealTimeTimeseriesResponse{}
	return &this
}
...
func (o *GetRealTimeTimeseriesResponse) GetData() []RealTimeTimeseriesDatapoint {
	if o == nil || o.Data == nil {
		var ret []RealTimeTimeseriesDatapoint
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []RealTimeTimeseriesDatapoint and assigns it to the Data field.
...
func (o GetRealTimeTimeseriesResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetRealTimeTimeseriesResponse struct {
	value *GetRealTimeTimeseriesResponse
	isSet bool
}

func (v NullableGetRealTimeTimeseriesResponse) Get() *GetRealTimeTimeseriesResponse {
	return v.value
}

func (v *NullableGetRealTimeTimeseriesResponse) Set(val *GetRealTimeTimeseriesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRealTimeTimeseriesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRealTimeTimeseriesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRealTimeTimeseriesResponse(val *GetRealTimeTimeseriesResponse) *NullableGetRealTimeTimeseriesResponse {
	return &NullableGetRealTimeTimeseriesResponse{value: val, isSet: true}
}

func (v NullableGetRealTimeTimeseriesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRealTimeTimeseriesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
